...
function loadSaturationData() {
    ...
    try {
        ...
        console.error('✗ Error loading R513A Saturation data:', error.message);
        throw error;
    }
}
...
function getSaturationPressure(temperature) {
    ...
    if (bestEntry && minDiff < 5) { // Allow up to 5C difference for safety, though table is 1C
        return {
 ...
 * Used for Point 2: Condenser Outlet
 */
 ...
 * Used for Point 3: Evaporator Inlet
 */
 ...
 * Used for fallback when superheat lookup fails
 */
